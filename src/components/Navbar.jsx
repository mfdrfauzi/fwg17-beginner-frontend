...
const Navbar = ({bgColor,position}) => {
    ...
    return (
        <nav id="navbar" className={`${!menuOpen ? 'h-20' : ''} flex flex-col md:flex-row md:h-20 w-full ${bgColor} text-white items-center px-16 md:px-20 gap-4 md:gap-0 py-6 md:py-0 ${position} overflow-hidden transition-all duration-300 ease-in-out`}>
